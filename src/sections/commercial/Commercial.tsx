...
import i7 from "@/assets/new/of2.jpg";
import i9 from "@/assets/new/of3.jpg";
import i12 from "@/assets/new/of6.jpg";
import i13 from "@/assets/new/office.jpg";
...
export default function Commercials() {
  ...
  return (
    <section className="py-24 container">
      <div className="columns-1  lg:columns-2 gap-8 space-x-2">
        {images.map((img, i) => (
          <motion.div
            key={i}
            className="relative w-full object-cover group overflow-hidden rounded-lg shadow-md cursor-pointer hover:scale-110 active:scale-110"
