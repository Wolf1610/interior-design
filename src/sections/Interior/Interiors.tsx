...
import i1 from "@/assets/home-design-8.jpg";
import i2 from "@/assets/office-3.jpg";
import Image from "next/image";
import { useRouter } from "next/navigation";

const teamMembers = [
  { id: 1, link: "/project-category/residental-apartments", name: "RESIDENTAL BUNGLOWS AND APARTMENTS", image: i1 },
  { id: 2, link: "/project-category/corporate", name: "CORPORATE", image: i2 },
];
